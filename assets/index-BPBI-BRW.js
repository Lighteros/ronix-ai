import { f as M, g as sr, h as ir } from "./index-UZGxpJ6H.js";
import {
  j as ar,
  s as or,
  r as Et,
...
(function (r) {
  ...
  function n(d, p = t) {
    if (d && Number.isInteger(d)) {
      ...
      if (c(d)) return r.JSON_RPC_SERVER_ERROR_MESSAGE;
    }
    return p;
  }
    ...
    if (
      ...
      (m.code = B.code),
        B.message && typeof B.message == "string"
          ...
          : ((m.message = n(m.code)), (m.data = { originalError: l(d) }));
    } else
...
be.standardErrors = {
  rpc: {
    ...
    resourceUnavailable: (r) =>
      C(v.standardErrorCodes.rpc.resourceUnavailable, r),
    transactionRejected: (r) =>
      C(v.standardErrorCodes.rpc.transactionRejected, r),
    methodNotSupported: (r) =>
      C(v.standardErrorCodes.rpc.methodNotSupported, r),
    limitExceeded: (r) => C(v.standardErrorCodes.rpc.limitExceeded, r),
  },
  provider: {
    userRejectedRequest: (r) =>
      $(v.standardErrorCodes.provider.userRejectedRequest, r),
    unauthorized: (r) => $(v.standardErrorCodes.provider.unauthorized, r),
    unsupportedMethod: (r) =>
      $(v.standardErrorCodes.provider.unsupportedMethod, r),
    disconnected: (r) => $(v.standardErrorCodes.provider.disconnected, r),
    chainDisconnected: (r) =>
      $(v.standardErrorCodes.provider.chainDisconnected, r),
    unsupportedChain: (r) =>
      $(v.standardErrorCodes.provider.unsupportedChain, r),
    custom: (r) => {
      if (!r || typeof r != "object" || Array.isArray(r))
        throw new Error(
...
function C(r, e) {
  const [t, n] = Ct(e);
  return new kt(r, t || (0, St.getMessageFromCode)(r), n);
}
function $(r, e) {
  const [t, n] = Ct(e);
  return new It(r, t || (0, St.getMessageFromCode)(r), n);
}
function Ct(r) {
  if (r) {
...
const pr = Q,
  ...
  br = Fe;
function yr(r, e) {
  const t = (0, br.serialize)(wr(r), { shouldIncludeStack: !0 }),
    n = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  n.searchParams.set("version", fr.LIB_VERSION),
...
ye.serializeError = yr;
function wr(r) {
  return typeof r == "string"
    ? { message: r, code: mr.standardErrorCodes.rpc.internal }
    : (0, pr.isErrorResponse)(r)
...
u.hexStringToUint8Array = Sr;
function Cr(r, e = !1) {
  const t = r.toString("hex");
  return (0, I.HexString)(e ? `0x${t}` : t);
}
u.hexStringFromBuffer = Cr;
function kr(r) {
  return (0, I.BigIntString)(r.toString(10));
}
u.bigIntStringFromBigInt = kr;
function Ir(r) {
  return (0, I.IntNumber)(Number(BigInt(ne(r, !0))));
}
u.intNumberFromHexString = Ir;
function Mr(r) {
  return (0, I.HexString)(`0x${BigInt(r).toString(16)}`);
}
u.hexStringFromIntNumber = Mr;
function ze(r) {
  return r.startsWith("0x") || r.startsWith("0X");
}
u.has0xPrefix = ze;
function we(r) {
  return ze(r) ? r.slice(2) : r;
}
u.strip0x = we;
function Rt(r) {
  return ze(r) ? `0x${r.slice(2)}` : `0x${r}`;
}
u.prepend0x = Rt;
function re(r) {
...
function xt(r, e = !1) {
  ...
  throw q.standardErrors.rpc.invalidParams(
    `"${String(r)}" is not a hexadecimal string`
  );
}
...
function Lr(r) {
  ...
  throw q.standardErrors.rpc.invalidParams(
    `Invalid Ethereum address: ${String(r)}`
  );
}
u.ensureAddressString = Lr;
function Ar(r) {
...
u.ensureBuffer = Ar;
function Pt(r) {
  if (typeof r == "number" && Number.isInteger(r)) return (0, I.IntNumber)(r);
  if (typeof r == "string") {
    if (Mt.test(r)) return (0, I.IntNumber)(Number(r));
    if (re(r)) return (0, I.IntNumber)(Number(BigInt(ne(r, !0))));
  }
  throw q.standardErrors.rpc.invalidParams(`Not an integer: ${String(r)}`);
}
u.ensureIntNumber = Pt;
function Rr(r) {
  if (r instanceof RegExp) return (0, I.RegExpString)(r.toString());
  throw q.standardErrors.rpc.invalidParams(`Not a RegExp: ${String(r)}`);
}
u.ensureRegExpString = Rr;
function xr(r) {
  if (r !== null && (typeof r == "bigint" || Nt(r)))
    return BigInt(r.toString(10));
  if (typeof r == "number") return BigInt(Pt(r));
  if (typeof r == "string") {
    if (Mt.test(r)) return BigInt(r);
    if (re(r)) return BigInt(ne(r, !0));
  }
  throw q.standardErrors.rpc.invalidParams(`Not an integer: ${String(r)}`);
}
u.ensureBigInt = xr;
function Pr(r) {
  ...
  throw q.standardErrors.rpc.invalidParams(
    `Not a JSON string or an object: ${String(r)}`
  );
}
u.ensureParsedJSONObject = Pr;
function Nt(r) {
  if (r == null || typeof r.constructor != "function") return !1;
...
y.encrypt = Ot;
async function Tt(r, { iv: e, cipherText: t }) {
  const n = await crypto.subtle.decrypt({ name: "AES-GCM", iv: e }, r, t);
...
async function Wr(r, e) {
  ...
  return (0, jt.uint8ArrayToHex)(new Uint8Array(n));
}
y.exportKeyToHexString = Wr;
async function Ur(r, e) {
  const t = Dt(r),
    n = (0, jt.hexStringToUint8Array)(e).buffer;
...
async function Hr(r, e) {
  return JSON.parse(await Tt(e, r));
}
y.decryptContent = Hr;
var T = {};
...
class pe {
  ...
  static clearAll() {
    new pe("CBWSDK").clear(), new pe("walletlink").clear();
  }
}
T.ScopedLocalStorage = pe;
Object.defineProperty(_e, "__esModule", { value: !0 });
_e.SCWKeyManager = void 0;
const ae = y,
  Kr = T,
  Te = { storageKey: "ownPrivateKey", keyType: "private" },
  De = { storageKey: "ownPublicKey", keyType: "public" },
  We = { storageKey: "peerPublicKey", keyType: "public" };
class qr {
  constructor() {
    (this.storage = new Kr.ScopedLocalStorage("CBWSDK", "SCWKeyManager")),
  ...
  async generateKeyPair() {
    const e = await (0, ae.generateKeyPair)();
    (this.ownPrivateKey = e.privateKey),
      (this.ownPublicKey = e.publicKey),
      await this.storeKey(Te, e.privateKey),
      await this.storeKey(De, e.publicKey);
  }
  async loadKeysIfNeeded() {
    if (
      (this.ownPrivateKey === null &&
        (this.ownPrivateKey = await this.loadKey(Te)),
      this.ownPublicKey === null &&
        (this.ownPublicKey = await this.loadKey(De)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) &&
        (await this.generateKeyPair()),
      this.peerPublicKey === null &&
        (this.peerPublicKey = await this.loadKey(We)),
      this.sharedSecret === null)
    ) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null) return;
      this.sharedSecret = await (0, ae.deriveSharedSecret)(
        this.ownPrivateKey,
        this.peerPublicKey
      );
    }
  ...
  async loadKey(e) {
    ...
    return t ? (0, ae.importKeyFromHexString)(e.keyType, t) : null;
  }
  async storeKey(e, t) {
    const n = await (0, ae.exportKeyToHexString)(e.keyType, t);
...
class Fr {
  ...
  constructor(e) {
    var t, n;
    (this.storage = new $r.ScopedLocalStorage("CBWSDK", "SCWStateManager")),
    ...
    s &&
      ...
      (this._activeChain = i || {
        id:
          (n = (t = e.appChainIds) === null || t === void 0 ? void 0 : t[0]) !==
            null && n !== void 0
            ? n
            : 1,
      });
  ...
  switchChain(e) {
    ...
    return n
      ? (n === this._activeChain ||
          ...
          this.updateListener.onChainUpdate({ chain: n, source: "wallet" })),
        !0)
      : !1;
  }
  ...
  updateWalletCapabilities(e) {
    (this._walletCapabilities = e), this.storeItemToStorage(rt, e);
  }
...
class Zr {
  constructor(e) {
    (this.metadata = e.metadata),
      ...
      (this.keyManager = new zr.SCWKeyManager()),
      (this.stateManager = new Vr.SCWStateManager({
  ...
  async handshake() {
    ...
    const n = await (0, ce.importKeyFromHexString)("public", t.sender);
  ...
  async sendEncryptedRequest(e) {
    ...
    const n = await (0, ce.encryptContent)(
  ...
  async createRequestMessage(e) {
    const t = await (0, ce.exportKeyToHexString)(
      "public",
  ...
  async decryptResponseMessage(e) {
    ...
    if (!n) throw oe.standardErrors.provider.unauthorized("Invalid session");
    return (0, ce.decryptContent)(t.encrypted, n);
  }
...
function Ce(r) {
  if (!Buffer.isBuffer(r))
    if (Array.isArray(r)) r = Buffer.from(r);
      ...
      Ht(r) ? (r = Buffer.from(tn(Kt(r)), "hex")) : (r = Buffer.from(r));
    else if (typeof r == "number") r = intToBuffer(r);
    else if (r == null) r = Buffer.allocUnsafe(0);
    else if (typeof r == "bigint") r = Ut(r);
    else if (r.toArray) r = Buffer.from(r.toArray());
    else throw new Error("invalid type");
  return r;
}
function Xr(r) {
  return (r = Ce(r)), "0x" + r.toString("hex");
}
function en(r, e) {
  return (
    (r = Ce(r)),
...
function H(r) {
  var e = typeof r;
  if (e === "string" || e === "number") return BigInt(r);
  if (e === "bigint") return r;
  throw new Error("Argument is not a number");
}
function R(r, e) {
  var t, n, s, i;
  if (r === "address") return R("uint160", H(e));
  if (r === "bool") return R("uint8", e ? 1 : 0);
  if (r === "string") return R("bytes", new Buffer(e, "utf8"));
  if (nn(r)) {
    if (typeof e.length > "u") throw new Error("Not an array?");
    if (((t = Ft(r)), t !== "dynamic" && t !== 0 && e.length > t))
      throw new Error("Elements exceed array size: " + t);
    (s = []),
      (r = r.slice(0, r.lastIndexOf("["))),
      typeof e == "string" && (e = JSON.parse(e));
    for (i in e) s.push(R(r, e[i]));
    if (t === "dynamic") {
    ...
    if (r.startsWith("bytes")) {
      ...
      return (t = st(r)), R("int256", H(e) * BigInt(2) ** BigInt(t[1]));
  }
...
function sn(r, e) {
  ...
  for (var i in r) {
    var a = $t(r[i]),
      o = e[i],
      c = R(a, o);
    rn(a) ? (t.push(R("uint256", s)), n.push(c), (s += c.length)) : t.push(c);
  }
...
function an(r, e) {
  return E.keccak(zt(r, e));
}
var on = { rawEncode: sn, solidityPack: zt, soliditySHA3: an };
const A = qt,
  X = on,
  Vt = {
    type: "object",
  ...
  Ue = {
          ...
          if (t[c] !== void 0)
            return [
              ...
              l == null
                ...
                : A.keccak(this.encodeData(c, l, t, n)),
            ];
          if (l === void 0)
    ...
    sanitizeData(r) {
      const e = {};
      for (const t in Vt.properties) r[t] && (e[t] = r[t]);
      return (
    ...
    hash(r, e = !0) {
      ...
      return (
        n.push(this.hashStruct("EIP712Domain", t.domain, t.types, e)),
        t.primaryType !== "EIP712Domain" &&
          n.push(this.hashStruct(t.primaryType, t.message, t.types, e)),
...
function dn(r) {
  ...
  if (typeof r != "object" || !r.length) throw e;
  ...
  return X.soliditySHA3(
    ["bytes32", "bytes32"],
    [
      X.soliditySHA3(new Array(r.length).fill("string"), s),
      X.soliditySHA3(n, t),
    ]
  );
}
    ...
    return new Promise((n, s) => {
      (async function () {
        const i = await crypto.subtle.importKey(
          ...
          a = (0, de.hexStringToUint8Array)(e),
          o = a.slice(0, 12),
          c = a.slice(12, 28),
          l = a.slice(28),
...
class yn {
  constructor({
    ...
    (this.destroyed = !1),
      ...
      (this.session = e),
      (this.cipher = new fn.WalletLinkCipher(e.secret)),
      (this.listener = n);
    ...
    i.setConnectionStateListener(async (a) => {
      ...
      (this.ws = i),
      (this.http = new mn.WalletLinkHTTP(t, e.id, e.key));
  }
  connect() {
...
class Ve {
  constructor(e, t, n, s) {
    (this._storage = e),
      (this._id = t || (0, ot.randomBytesHex)(16)),
      (this._secret = n || (0, ot.randomBytesHex)(32)),
      (this._key = new wn.sha256()
  ...
  static load(e) {
    const t = e.getItem(ct),
      n = e.getItem(lt),
      s = e.getItem(dt);
    return t && s ? new Ve(e, t, s, n === "1") : null;
  }
  get id() {
    return this._id;
  }
  ...
  save() {
    return (
      this._storage.setItem(ct, this._id),
...
function En() {
  try {
    return _n() && window.top ? window.top.location : window.location;
  } catch {
...
function Sn() {
  ...
  return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
    (r = window == null ? void 0 : window.navigator) === null || r === void 0
      ? void 0
      : r.userAgent
  );
}
...
function Cn() {
  var r, e;
  return (e =
    (r = window == null ? void 0 : window.matchMedia) === null || r === void 0
      ? void 0
      : r.call(window, "(prefers-color-scheme: dark)").matches) !== null &&
    e !== void 0
    ? e
    : !1;
}
...
function Mn() {
  ...
  (r.type = "text/css"),
    r.appendChild(document.createTextNode(In.default)),
    document.documentElement.appendChild(r);
}
ie.injectCssReset = Mn;
var Ge = {};
function Zt(r) {
  var e,
    t,
...
(function (r) {
          ...
          (0, n.h)(
            ...
            (0, n.h)(
              ...
              Array.from(this.items.entries()).map(([p, m]) =>
                (0, n.h)(r.SnackbarInstance, Object.assign({}, m, { key: p }))
              )
            )
          ),
          this.root
  ...
  const f = ({ autoExpand: d, message: p, menuItems: m }) => {
    const [B, tr] = (0, s.useState)(!0),
      [Oe, Qe] = (0, s.useState)(d ?? !1);
    (0, s.useEffect)(() => {
      const L = [
        window.setTimeout(() => {
          tr(!1);
    ...
    return (0, n.h)(
      ...
      (0, n.h)(
        "div",
        { class: "-cbwsdk-snackbar-instance-header", onClick: rr },
        (0, n.h)("img", {
          src: o,
...
class xn {
  constructor() {
    (this.attached = !1), (this.snackbar = new Rn.Snackbar());
  }
  attach() {
    if (this.attached)
...
class Dn {
  constructor() {
    (this.root = null), (this.darkMode = (0, On.isDarkMode)());
  }
  attach() {
    const e = document.documentElement;
    (this.root = document.createElement("div")),
...
const Wn = ({
  ...
  return (0, x.h)(
    jn.SnackbarContainer,
    { darkMode: t },
    (0, x.h)(
      "div",
      { class: "-cbwsdk-redirect-dialog" },
      (0, x.h)("style", null, Tn.default),
      (0, x.h)("div", {
      ...
      (0, x.h)(
        "div",
        { class: (0, Pn.default)("-cbwsdk-redirect-dialog-box", i) },
        (0, x.h)("p", null, r),
        (0, x.h)("button", { onClick: n }, e)
      )
    )
  );
};
...
class Kn {
  constructor() {
    (this.attached = !1), (this.redirectDialog = new Un.RedirectDialog());
  }
  attach() {
    if (this.attached)
      throw new Error("Coinbase Wallet SDK UI is already attached");
  ...
  redirectToCoinbaseWallet(e) {
    const t = new URL(Hn.CBW_MOBILE_DEEPLINK_URL);
    t.searchParams.append("redirect_url", (0, Bn.getLocation)().href),
...
class W {
  constructor(e) {
    (this.accountsCallback = null),
      ...
      (this.isMobileWeb = (0, zn.isMobileWeb)()),
      (this.appName = ""),
      (this.appLogoUrl = null),
      (this.linkedUpdated = (i) => {
        this.isLinked = i;
        const a = this.storage.getItem($n.LOCAL_STORAGE_ADDRESSES_KEY);
        if (
    ...
    (this._session = t),
      (this.connection = s),
      (this.relayEventManager = new Fn.RelayEventManager()),
      (this.ui = n);
  }
  subscribe() {
    const e =
        Be.WalletLinkSession.load(this.storage) ||
        new Be.WalletLinkSession(this.storage).save(),
      { linkAPIUrl: t } = this,
      n = new qn.WalletLinkConnection({
        session: e,
        linkAPIUrl: t,
        listener: this,
      }),
      s = this.isMobileWeb
        ? new ht.WLMobileRelayUI()
        : new Vn.WalletLinkRelayUI();
    ...
    Promise.race([
      ...
      .then(() => {
        ...
        (e == null ? void 0 : e.id) === this._session.id &&
          Gn.ScopedLocalStorage.clearAll(),
  ...
  openCoinbaseWalletDeeplink(e) {
    if (this.ui instanceof ht.WLMobileRelayUI)
      switch (e) {
  ...
  handleWeb3ResponseMessage(e) {
    ...
    if (t.method === "requestEthereumAccounts") {
      W.accountRequestCallbackIds.forEach((n) =>
        this.invokeCallback(Object.assign(Object.assign({}, e), { id: n }))
      ),
        W.accountRequestCallbackIds.clear();
      return;
    }
  ...
  requestEthereumAccounts() {
    ...
    return new Promise((n, s) => {
      this.relayEventManager.callbacks.set(t, (i) => {
        if ((0, z.isErrorResponse)(i)) return s(new Error(i.errorMessage));
        n(i);
      }),
  ...
  switchEthereumChain(e, t) {
    ...
    return new Promise((i, a) => {
      this.relayEventManager.callbacks.set(s, (o) => {
        ...
        if ((0, z.isErrorResponse)(o)) return a(new Error(o.errorMessage));
        i(o);
      }),
...
class es {
  constructor(e) {
    ...
    (this._appName = s),
      (this._appLogoUrl = i),
      (this._storage = new Xn.ScopedLocalStorage(
        "walletlink",
        pt.WALLETLINK_URL
      )),
      (this.updateListener = e.updateListener),
      (this._relayEventManager = new Jn.RelayEventManager()),
      (this._jsonRpcUrlFromOpts = "");
    const a = this._storage.getItem(gt.LOCAL_STORAGE_ADDRESSES_KEY);
    if (a) {
      const c = a.split(" ");
      c[0] !== "" &&
    ...
    this._storage.getItem(Ke) &&
      ((n = this.updateListener) === null ||
        n === void 0 ||
        n.onChainUpdate({
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(ft)) !== null && e !== void 0
      ? e
      : this._jsonRpcUrlFromOpts;
  }
  set jsonRpcUrl(e) {
    this._storage.setItem(ft, e);
  }
  updateProviderInfo(e, t) {
    ...
    this._storage.setItem(Ke, t.toString(10)),
      ((0, g.ensureIntNumber)(t) !== s ||
        ...
        ((n = this.updateListener) === null ||
          n === void 0 ||
          n.onChainUpdate({ chain: { id: t, rpcUrl: e }, source: "wallet" }),
        (this.hasMadeFirstChainChangedEmission = !0));
  }
  ...
  async switchEthereumChain(e) {
    const n = await this.initializeRelay().switchEthereumChain(
      e.toString(10),
      this.selectedAddress || void 0
    );
    if ((0, D.isErrorResponse)(n)) {
      if (!n.errorCode) return;
      throw n.errorCode === w.standardErrorCodes.provider.unsupportedChain
  ...
  _setAddresses(e, t) {
    ...
    JSON.stringify(s) !== JSON.stringify(this._addresses) &&
      ...
      (n = this.updateListener) === null ||
        n === void 0 ||
        n.onAccountsUpdate({ accounts: s, source: "wallet" }),
      this._storage.setItem(gt.LOCAL_STORAGE_ADDRESSES_KEY, s.join(" ")));
  }
  _sendRequestAsync(e) {
  ...
  _prepareTransactionParams(e) {
    ...
    const n = e.to ? (0, g.ensureAddressString)(e.to) : null,
  ...
  async _eth_signTypedData_v1(e) {
    ...
    const s = He.default.hashForSignTypedDataLegacy({ data: t }),
  ...
  async _eth_signTypedData_v3(e) {
    this._requireAuthorization();
    const t = (0, g.ensureAddressString)(e[0]),
      n = (0, g.ensureParsedJSONObject)(e[1]);
    this._ensureKnownAddress(t);
    const s = He.default.hashForSignTypedData_v3({ data: n }),
  ...
  async _eth_signTypedData_v4(e) {
    ...
    const t = (0, g.ensureAddressString)(e[0]),
      n = (0, g.ensureParsedJSONObject)(e[1]);
    this._ensureKnownAddress(t);
    const s = He.default.hashForSignTypedData_v4({ data: n }),
      i = JSON.stringify(n, null, 2);
    return this._signEthereumMessage(s, t, !1, i);
  }
  ...
  initializeRelay() {
    if (!this._relay) {
      const e = new Qn.WalletLinkRelay({
        linkAPIUrl: pt.WALLETLINK_URL,
    ...
    await (
      await window.fetch(e.rpcUrl, {
        ...
        headers: {
          ...
          "X-Cbw-Sdk-Version": ts.LIB_VERSION,
        },
      })
    ).json()
  ).result;
}
k.fetchRPCRequest = rs;
function Jt() {
  return globalThis.coinbaseWalletSigner;
}
k.getCoinbaseInjectedSigner = Jt;
function ns({ metadata: r, preference: e }) {
  var t, n, s;
  const i = globalThis;
  ...
  const a =
    (n = i.ethereum) !== null && n !== void 0
      ? n
      : (s = i.top) === null || s === void 0
      ? void 0
      : s.ethereum;
  if (a != null && a.isCoinbaseBrowser) return a;
}
k.getCoinbaseInjectedProvider = ns;
function ss(r) {
  if (!r || typeof r != "object" || Array.isArray(r))
...
k.checkErrorForInvalidRequestArgs = ss;
...
const is = ve,
  ...
  cs = T,
  Xt = "SignerType",
  er = new cs.ScopedLocalStorage("CBWSDK", "SignerConfigurator");
function ds() {
  return er.getItem(Xt);
}
P.loadSignerType = ds;
function ls(r) {
  er.setItem(Xt, r);
}
P.storeSignerType = ls;
async function us(r) {
...
P.fetchSignerType = us;
function hs(r) {
  const { signerType: e, metadata: t, communicator: n, updateListener: s } = r;
  switch (e) {
    case "scw":
      return new is.SCWSigner({
        metadata: t,
        updateListener: s,
        communicator: n,
      });
    case "walletlink":
      return new Qt.WalletLinkSigner({ metadata: t, updateListener: s });
    case "extension": {
      const i = (0, os.getCoinbaseInjectedSigner)();
      if (!i) throw as.standardErrors.rpc.internal("injected signer not found");
      return i;
    }
  }
}
...
async function gs(r, e) {
  ...
  const t = new Qt.WalletLinkSigner({ metadata: e });
  r.postMessage({
    event: "WalletLinkUpdate",
    data: { session: t.getSession() },
  }),
    await t.handshake(),
    r.postMessage({ event: "WalletLinkUpdate", data: { connected: !0 } });
}
var Ne = {},
  J = {};
Object.defineProperty(J, "__esModule", { value: !0 });
...
const ps = O,
  ...
  bt = 540;
function fs(r) {
  const e = (window.innerWidth - mt) / 2 + window.screenX,
    t = (window.innerHeight - bt) / 2 + window.screenY,
    n = window.open(
      r,
      "Smart Wallet",
      `width=${mt}, height=${bt}, left=${e}, top=${t}`
    );
  if ((n == null || n.focus(), !n))
    throw ps.standardErrors.rpc.internal("Pop up window failed to open");
  return n;
}
J.openPopup = fs;
function ms(r) {
...
class ws {
  constructor(e = ys.CB_KEYS_URL) {
    (this.popup = null),
      ...
      (this.disconnect = () => {
        (0, yt.closePopup)(this.popup),
          (this.popup = null),
          this.listeners.forEach(({ reject: t }, n) => {
            t(
              wt.standardErrors.provider.userRejectedRequest("Request rejected")
            ),
      ...
      (this.waitForPopupLoaded = async () =>
        this.popup && !this.popup.closed
          ? this.popup
          : ((this.popup = (0, yt.openPopup)(this.url)),
            ...
            this.onMessage(({ event: t }) => t === "PopupLoaded")
              .then((t) => {
                this.postMessage({
                  requestId: t.id,
                  data: { version: bs.LIB_VERSION },
                });
              })
              .then(() => {
                if (!this.popup) throw wt.standardErrors.rpc.internal();
                return this.popup;
              }))),
      (this.url = new URL(e));
  }
...
function vs(r) {
  for (const e in vt) {
    const t = e;
    if (vt[t].includes(r)) return t;
  }
}
je.determineMethodCategory = vs;
var _s =
    (M && M.__rest) ||
    function (r, e) {
      var t = {};
...
class Ls extends Ss.default {
  constructor(e) {
    ...
    super(),
      ...
      (this.handlers = {
        handshake: async (l) => {
          try {
            if (this.connected)
              return (
                this.emit("connect", {
                  chainId: (0, ue.hexStringFromIntNumber)(
                    (0, qe.IntNumber)(this.chain.id)
                  ),
                }),
                this.accounts
              );
        ...
        fetch: (l) => (0, _t.fetchRPCRequest)(l, this.chain),
        state: (l) => {
          const h = () => {
        ...
        deprecated: ({ method: l }) => {
          throw V.standardErrors.rpc.methodNotSupported(
      ...
      (this.updateListener = {
        onAccountsUpdate: ({ accounts: l, source: h }) => {
          (0, ue.areAddressArraysEqual)(this.accounts, l) ||
            ((this.accounts = l),
        ...
        onChainUpdate: ({ chain: l, source: h }) => {
          (l.id === this.chain.id && l.rpcUrl === this.chain.rpcUrl) ||
            ...
            h !== "storage" &&
              this.emit(
                "chainChanged",
                (0, ue.hexStringFromIntNumber)((0, qe.IntNumber)(l.id))
              ));
        },
      }),
      (this.metadata = s),
      (this.preference = o),
      (this.communicator = new ks.Communicator(a)),
      (this.chain = {
        id:
          (n = (t = s.appChainIds) === null || t === void 0 ? void 0 : t[0]) !==
            null && n !== void 0
            ? n
            : 1,
      });
    const c = (0, he.loadSignerType)();
  ...
  async request(e) {
    var t;
    try {
      const n = (0, _t.checkErrorForInvalidRequestArgs)(e);
      if (n) throw n;
      const s =
        (t = (0, Is.determineMethodCategory)(e.method)) !== null && t !== void 0
          ? t
          : "fetch";
      return this.handlers[s](e);
    } catch (n) {
      return Promise.reject((0, Cs.serializeError)(n, e.method));
    }
  }
  ...
  async disconnect() {
    (this.accounts = []),
      (this.chain = { id: 1 }),
      Ms.ScopedLocalStorage.clearAll(),
      this.emit(
        "disconnect",
        V.standardErrors.provider.disconnected("User initiated disconnection")
      );
  }
  requestSignerSelection() {
    return (0, he.fetchSignerType)({
...
class Os {
  constructor(e) {
    (this.metadata = {
      ...
      appLogoUrl: e.appLogoUrl || (0, Ns.getFavicon)(),
  ...
  makeWeb3Provider(e = { options: "all" }) {
    ...
    return (t = (0, js.getCoinbaseInjectedProvider)(n)) !== null && t !== void 0
      ? t
      : new Rs.CoinbaseWalletProvider(n);
  }
  getCoinbaseWalletLogo(e, t = 240) {
    return (0, As.walletLogo)(e, t);
  }
  storeLatestVersion() {
    new xs.ScopedLocalStorage("CBWSDK").setItem("VERSION", Ps.LIB_VERSION);
  }
}
ee.CoinbaseWalletSDK = Os;
(function (r) {
  Object.defineProperty(r, "__esModule", { value: !0 }),
...
const Ts = ir($e),
  Us = lr({ __proto__: null, default: Ts }, [$e]);
export { Us as i };
